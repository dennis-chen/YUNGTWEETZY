...
def do_syllables_match(syl_list_1,syl_list_2):
    """tells you whether two syllables in the cmu dictionary format are the same syllable by removing other data and comparing just the letters"""
...
def do_sentences_rhyme(sentence_1,sentence_2,dictionary):
    """returns whether the last words of 2 sentences rhyme, this is a simple implementation"""
